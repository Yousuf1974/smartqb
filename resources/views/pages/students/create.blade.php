                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_name" value="{{old('student_name')}}" class="form-control form-control-sm @error('student_name') is-invalid @enderror" placeholder="Student Name" id="name" />
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="student_contact" value="{{old('student_contact')}}" class="form-control form-control-sm @error('student_contact') is-invalid @enderror" placeholder="Student Contact" id="phone" />
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="guardian_name" value="{{old('guardian_name')}}" class="form-control form-control-sm @error('guardian_name') is-invalid @enderror" placeholder="Guardian Name" id="guardian_name"  />
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="guardian_contact" value="{{old('guardian_contact')}}" class="form-control form-control-sm @error('guardian_contact') is-invalid @enderror" placeholder="Guardian Contact" id="father_contact" />
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly name="student_class" value="{{old('student_class')}}" class="form-control form-control-sm @error('student_class') is-invalid @enderror" placeholder="Student Class" id="class" />
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="clg_name" value="{{old('clg_name')}}" class="form-control form-control-sm @error('clg_name') is-invalid @enderror" placeholder="College Name" id="clg" />
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="admission_date" value="{{old('admission_date') ?? date('Y-m-d')}}" class="form-control form-control-sm @error('admission_date') is-invalid @enderror" id="admission_date" required />
                            ...
                            <input type="file" accept="image/*" style="display: none;" name="user_profile" id="user_profile">
                            {{-- camera photo data --}}
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="note_address" id="" cols="30" rows="5" class="form-control form-control-sm" placeholder="Note/Address">{{old('note_address')}}</textarea>
                                </div>
                            </div>
