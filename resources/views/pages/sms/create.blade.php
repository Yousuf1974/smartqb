        ...
        <div class="col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        @can('sms-create')
                        <div class="@can('sms-index') col-md-4 @endcan col-sm-12 border rounded p-2">
                            <form action="{{route('sms.store')}}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="qty">Quantity* (Pcs)</label>
                                    <input type="number" name="quantity" value="{{old('quantity')}}" id="qty" min="0" step="1" class="form-control" placeholder="Quantity" required>
                                    @error('quantity')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="validity" id="validity" value="{{old('validity')}}" min="0" step="1" class="form-control" placeholder="Validity(Day)" required>
                                    @error('validity')
                                    <p class="text-danger"><small>{{$message}}</small></p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" id="price" value="{{old('price')}}" min="0" step="1" class="form-control" placeholder="Price" required>
                                    @error('price')
                                    <p class="text-danger"><small>{{$message}}</small></p>
                                    @enderror
                                </div>
                        ...
                        @can('sms-index')
                        <div class="@can('sms-create') col-md-8 @endcan col-sm-12 p-2">
