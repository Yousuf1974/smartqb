    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item "><a href="{{route("users")}}">Admin User</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="name" value="{{$user->name}}" id="name" class="form-control form-control-sm @error('name') is-invalid @enderror " required />
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="tel" name="phone" placeholder="Phone" value="{{$user->phone}}" id="phone" class="form-control form-control-sm @error('phone') is-invalid @enderror " required/>
